...
import com.martinatanasov.colornotebook.view.details.DetailsActivity;
...
public class NotificationCreator {
    ...
    public void createNotificationChannel(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            //Create channel 0: Important
            CharSequence name0 = activity.getString(R.string.set_important);
            String description0 = activity.getString(R.string.channel_description_important);
            int importance0 = NotificationManager.IMPORTANCE_HIGH;
            NotificationChannel channel0 = new NotificationChannel("important", name0, importance0);
            ...
            //Create channel 2: Unimportant
            CharSequence name2 = activity.getString(R.string.set_unimportant);
            String description2 = activity.getString(R.string.channel_description_unimportant);
            int importance2 = NotificationManager.IMPORTANCE_LOW;
            NotificationChannel channel2 = new NotificationChannel("unimportant", name2, importance2);
